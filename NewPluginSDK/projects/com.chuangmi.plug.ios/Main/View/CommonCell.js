...
var MHDevice=require('../../Main/MHDevice').MHDevice;
var Countdown = require('../Control/CountDown');
var MainPage = require('../Control/MainPage');//不带usb
...
//      },
 ...
 //      this.onFavorBtnPress(this.props.dataId, fff, url, type);
    ...
    onPlayBtnPress: function(){
      if(this.props.currentState!=undefined&&this.props.currentState!=null){
        // alert('currentState'+this.props.currentState);
      ...
      if(this.props.usbCurrentState!=undefined&&this.props.usbCurrentState!=null){
        // alert('usbCurrentState'+this.props.usbCurrentState);
        if(this.props.usbCurrentState){
          MHDevice.setSubPowerOff();
        }else{
          MHDevice.setSubPowerOn();
        }
      }
  ...
  componentWillUnmount: function(){
    ...
    render: function(){
        ...
        if(this.state.fuck){
           tmpView = (
                 ...
                 <Image style={styles.thumb_shadow} source={{isStatic:!MHPluginSDK.devMode, uri:MHPluginSDK.basePath + "holder_small.png" }} resizeMode='stretch'>
                        <Image style={styles.thumb} source={{isStatic:!MHPluginSDK.devMode, uri: MHPluginSDK.basePath +this.state.thumbSource }}>
                            {/* {playbtn} */}
                        </Image>
                </Image>
            ...
            tmpView = (
                  <View style={styles.thumb_shadow}>
                     <Image style={styles.thumb} source={{isStatic:!MHPluginSDK.devMode, uri:MHPluginSDK.basePath + "holder_small.png" }} resizeMode='stretch'>
                          <Image style={styles.thumb} source={{uri: MHPluginSDK.basePath +this.state.thumbSource}}>
                              {/* {playbtn} */}
                          </Image>
                    </Image>
                  </View>
        ...
        var color=(this.props.currentState||this.props.usbCurrentState)?'#2E95E9':'#20252B';
         return (
             <TouchableOpacity onPress={this.props.onRowPress}  >
                  <View style={[styles.cell,{backgroundColor:color}]} onLayout={this.onLayout}>
                     <TouchableWithoutFeedback onPress={this.onPlayBtnPress}>
                       ...
                       <View style={styles.rowTextDesc}>
                          ...
                          {/* <Image style={{marginRight:5,width:8,height:10}} source={icon_play}></Image> */}
                          {/* <Image style={{marginRight:5}} source={{isStatic:!MHPluginSDK.devMode, uri:MHPluginSDK.basePath + "icon_play.png" }} resizeMode='stretch'></Image> */}
                       ...
                       <StatusButtonWithImg
                            ...
                            selectedImg='enter_icon1@2x.png'
                            unSelectedImg='enter_icon1@2x.png'>
                        </StatusButtonWithImg>
