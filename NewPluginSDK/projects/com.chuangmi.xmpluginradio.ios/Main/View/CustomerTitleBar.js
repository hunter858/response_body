...
const imgHeight = 28;
export default class CustomerTitleBar extends Component {
  constructor(props) {
    super(props);
  }
  render() {
    ...
    return (
      <SafeAreaView style={[styles.titleBarContainer,this.props.style]}>
       ...
       ? <ImageButton onPress={this.props.onPressRight2}
              ...
              source={this.props.sourceRight2}
              highlightedSource={this.props.highlightedSourceRight2}/>:null}
        {this.props.rightText
          ?<RkButton onPress={this.props.onPressRight}
            ...
            : <ImageButton onPress={this.props.onPressRight}
                           ...
                           highlightedSource={this.props.highlightedSourceRight}/>
        }
        {
          this.props.showDot &&
