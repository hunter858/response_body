...
import {
 ...
 var SELECT_COLOR=Constants.TintColor.navBar;
 var SELECT_PRESS_COLOR = Constants.TintColor.navBar;
 var UNSELECT_TEXT_COLOR = Constants.TextColor.rgb0 ;
 var SELECT_TEXT_COLOR = 'white';


class InterestCommonBtn extends React.Component{
  ...
  render(){
    ...
    var container = {alignItems:'center', justifyContent:'center',backgroundColor:backColor};
...
InterestCommonBtn.defaultProps={
...
module.exports = InterestCommonBtn;
